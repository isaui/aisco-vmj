package aisco.product.yayasanrse;
...
public class YayasanRSE {
    ...
    public static List<Program> addProgram() {
        ...
        Program sharegifts = ProgramFactory.createProgram("aisco.program.activity.ProgramImpl", 1, "Share Gifts",
                "Sharing gifts to slum area", "50 persons", "RSE Volunteer",
                "https://www.yaysanpandhu.splelive.id/pandhu.jpg");
        Program orphanagecompetition = ProgramFactory.createProgram("aisco.program.activity.ProgramImpl", 2,
                "Orphanage Competition", "Competition of Orphanage in Karawang", "30 orphanages", "Government",
                "https://www.yaysanpandhu.splelive.id/panti.jpg");
        Program withcategory = ProgramFactory.createProgram("aisco.program.category.ProgramImpl", sharegifts,
                "Program Dhuafa");
        Program withscholarship = ProgramFactory.createProgram("aisco.program.scholarship.ProgramImpl", withcategory,
                "Scholarship Venedict", "Partial Scholarship", "4 years");
    ...
    public static List<FinancialReport> addIncome(List<Program> programs) {
        ...
        FinancialReport income1 = FinancialReportFactory
                .createFinancialReport("aisco.financialreport.income.FinancialReportImpl", core1, "Cash");
        ...
        income2 = FinancialReportFactory.createFinancialReport("aisco.financialreport.income.FinancialReportImpl",
                FinancialReportFactory.createFinancialReport("aisco.financialreport.core.FinancialReportImpl", "2",
                        "13-11-2019",
                        300000, "Donation Raden", programs.get(INDEX_ORPH), "11000"),
                "Transfer");
        incomes.add(income2);
        incomes.add(FinancialReportFactory.createFinancialReport("aisco.financialreport.income.FinancialReportImpl",
                FinancialReportFactory.createFinancialReport("aisco.financialreport.core.FinancialReportImpl", "3",
                        "14-11-2019",
                        500000, "Donation Anonim", programs.get(INDEX_GIFTS), "110"),
                "Transfer"));
    ...
    public static List<FinancialReport> addExpense(List<Program> programs) {
        ...
        expense1 = FinancialReportFactory.createFinancialReport("aisco.financialreport.expense.FinancialReportImpl",
                FinancialReportFactory.createFinancialReport("aisco.financialreport.core.FinancialReportImpl", "10",
                        "28-04-2020", 1000000, "Story Books", programs.get(INDEX_GIFTS), "50200"));
        FinancialReport freq2 = FinancialReportFactory.createFinancialReport(
    ...
    public static List<Program> addScholarship(List<Program> programs) {
        ...
        Program withscholarship = ProgramFactory.createProgram("aisco.program.scholarship.ProgramImpl", programs.get(0),
                "Scholarship Dhuafa", "Full Scholarship", "4 years");
        scholarships.add(withscholarship);
        return scholarships;
    }

    public static void main(String[] args) {
        System.out.println("Product Yayasan RSE");
        ...
        List<Program> scholarships = addScholarship(programs);
