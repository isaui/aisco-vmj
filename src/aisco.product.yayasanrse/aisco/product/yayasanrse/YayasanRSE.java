...
public class YayasanRSE {
        ...
        public static List<Program> addProgram() {
                ...
                Program sharegifts = ProgramFactory.createProgram("aisco.program.activity.ProgramImpl", 1,
                                "Share Gifts",
                ...
                Program orphanagecompetition = ProgramFactory.createProgram("aisco.program.activity.ProgramImpl", 2,
                                "Orphanage Competition", "Competition of Orphanage in Karawang", "30 orphanages",
                                "Government",
        ...
        public static List<FinancialReport> addIncome(List<Program> programs) {
                ...
                FinancialReport income1 = FinancialReportFactory
                                .createFinancialReport("aisco.financialreport.income.FinancialReportImpl", core1,
                                                "Cash");
                ...
                income2 = FinancialReportFactory.createFinancialReport(
                                "aisco.financialreport.income.FinancialReportImpl",
                                FinancialReportFactory.createFinancialReport(
                                                "aisco.financialreport.core.FinancialReportImpl", "2",
                                                "13-11-2019",
                ...
                incomes.add(FinancialReportFactory.createFinancialReport(
                                "aisco.financialreport.income.FinancialReportImpl",
                                FinancialReportFactory.createFinancialReport(
                                                "aisco.financialreport.core.FinancialReportImpl", "3",
                                                "14-11-2019",
        ...
        public static List<FinancialReport> addExpense(List<Program> programs) {
                ...
                expense1 = FinancialReportFactory.createFinancialReport(
                                ...
                                FinancialReportFactory.createFinancialReport(
                                                ...
                                                "28-04-2020", 1000000, "Story Books", programs.get(INDEX_GIFTS),
                                                "50200"));
                FinancialReport freq2 = FinancialReportFactory.createFinancialReport(
